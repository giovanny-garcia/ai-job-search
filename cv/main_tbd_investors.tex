...
\item \textbf{Gaps I would close on the job:} production web applications, cloud platforms, and data pipelines. I learn unfamiliar tools on a live problem, which is how the Discord bot and Claude Code workflow got built.
\end{itemize}
