...
> TBD is operators first, not a remote finance internship. They invest their own capital and stay close after the close. Metro Vein Centers is the public flagship (acquired and scaled over nine years). The portfolio listed on tbdinvestors.com includes healthcare and essential-service operators (Oaklin Lane, CoFi, Liine, Sainvus). The SWE intern builds tools those companies need. That matches how I already work: APIs, databases, automation, Claude Code.
